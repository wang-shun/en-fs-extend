 ...
 * @generated
 */
@Entity(id = "entity:com.chinacreator.c2.qyb.fs.entity.FileMetaInfo", table = "kcomp_file_upload", ds = "xzzx")
public class FileMetaInfo implements Serializable {
	private static final long serialVersionUID = 1895875280289792L;
	/**
	 *
	 */
